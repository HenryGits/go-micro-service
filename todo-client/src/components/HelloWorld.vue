...
<script>
    ...
    import {addTodoParams, deleteTodoParams, getTodoParams} from "../todo_pb";
    ...
    export default {
        ...
        created: function () {
            this.client = new todoServiceClient("http://localhost:9080", null, null);
            this.getTodos();
        },
        methods: {
            getTodos: function () {
                ...
                this.client.getTodos(getRequest, {}, (err, response) => {
                    this.todos = JSON.stringify(response.toObject().todosList);
